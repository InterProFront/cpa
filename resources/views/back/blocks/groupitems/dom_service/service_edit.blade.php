...
@section('content')
    ...
    <li class="group" data-group-id="{{$item_service->id_field}}">
        ...
        <ul class="group-block group_container" data-block="dom_service" data-group="0"
        ...
        <div class="block buttons">
            <button type="button" class="any_save" data-block="dom_service" data-group="service" data-entity="groupitem"
