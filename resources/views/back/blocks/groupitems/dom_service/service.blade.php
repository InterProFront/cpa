...
<td><a href="">{{$item_service->name_field}}</a></td>
<td></td>
<td>
...
<td><button type="button" class="any_delete" data-block="dom_service" data-group="service" data-entity="groupitem" data-item-id="{{$item_service->id_field}}" data-descr="Эл. первой группы"> Удалить</button>
</td>
</tr>
