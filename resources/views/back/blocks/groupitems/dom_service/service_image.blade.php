                ...
                <div class="drag-n-drop">
                    ...
                    <div class="img-hide-block">
                        <input type="hidden" class="prefix" data-field-name="serv_pict" data-group="service_image"
                               ...
                               data-block="dom_service" value="{{$item_service_image->serv_pict_image->prefix}}">
                        ...
                        <input type="hidden" class="secondary_link" data-field-name="serv_pict"
                               data-group="service_image" data-field-type="image"
                               data-item-id="{{$item_service_image->id_field}}" data-block="dom_service"
                               value="{{$item_service_image->serv_pict_image->secondary_link}}">
                        ...
                        <input type="hidden" class="original_link" data-field-name="serv_pict" data-group="service_image"
                               data-field-type="image" data-item-id="{{$item_service_image->id_field}}"
                               data-block="dom_service" value="{{$item_service_image->serv_pict_image->original_link}}">
                    </div>
                    ...
                    <div class="action-block">
                        <input type="text" placeholder="alt текст" class="alt-text"
                               ...
                               data-item-id="{{$item_service_image->id_field}}" data-field-name="serv_pict"
