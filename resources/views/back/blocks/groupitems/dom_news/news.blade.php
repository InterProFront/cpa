<li class="group" data-group-id="{{$item_news->id_field}}">
    ...
    <div class="block ">
        <div class="field-wrap ">
            ...
            <input type="text" data-field-type="string" data-field-name="link" data-block="dom_news" data-group="news"
                   class="input group_field" value="{{$item_news->link_field}}" data-item-id="{{$item_news->id_field}}"
                   placeholder="Строка">
        </div>
        <div class="field-wrap ">
            <label class="input-file">
