...
<div class="image-load">
        <div class="drag-n-drop">
            ...
            <div class="img-hide-block">
                <input type="hidden" class="prefix" data-field-name="fact_pict" data-group="fact" data-field-type="image" data-item-id="{{$item_fact->id_field}}" data-block="static_facts" value="{{$item_fact->fact_pict_image->prefix}}">
