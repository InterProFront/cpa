<li class="group" data-group-id="{{$item_course_image->id_field}}">
        ...
        <label class="input-file">
            <div class="image-load">
                <div class="img-hide-block">
                    ...
                    <input type="hidden" class="preview_link" data-field-name="course_pict" data-group="course_image"
                           data-field-type="image" data-item-id="{{$item_course_image->id_field}}"
                           data-block="dom_study" value="{{$item_course_image->course_pict_image->preview_link}}">
                    <input type="hidden" class="primary_link" data-field-name="course_pict" data-group="course_image"
                           data-field-type="image" data-item-id="{{$item_course_image->id_field}}"
                           data-block="dom_study" value="{{$item_course_image->course_pict_image->primary_link}}">
                    <input type="hidden" class="secondary_link" data-field-name="course_pict" data-group="course_image"
                           data-field-type="image" data-item-id="{{$item_course_image->id_field}}"
                           data-block="dom_study" value="{{$item_course_image->course_pict_image->secondary_link}}">
    ...
    <div class="block buttons_block">
        <button type="button" class="any_save" data-block="dom_study" data-group="course_image" data-entity="groupitem"
                data-item-id="{{$item_course_image->id_field}}" data-descr="Эл. первой группы"> Сохранить
        </button>
