@extends('back.layout')
@section('content')
    <?php $title='Учебный центр — ' . $item_course->course_title_field?>
    <li class="group" data-group-id="{{$item_course->id_field}}">
        ...
        <ul class="group-block group_container" data-block="dom_study" data-group="0"
            data-owner-id="{{$item_0->id_field}}">
        ...
        <div class="block ">
            <label class="input-file">
                <textarea data-field-type="text" data-field-name="about_course" data-block="dom_study"
        ...
        <div class="block buttons">
            <button type="button" class="any_save" data-block="dom_study" data-group="course" data-entity="groupitem"
