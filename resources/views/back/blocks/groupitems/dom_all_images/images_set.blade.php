        ...
        <div class="drag-n-drop">
            ...
            <div class="action-block">
                ...
                <label class="file-input">
                    Загрузить
                    <input type="file" accept="image/*" class="input_file block_field" data-field-name="text_pict" data-field-type="image" data-block="dom_all_images" data-group="images_set" data-item-id="{{$item_images_set->id_field}}" data-entity="groupitem">
                </label>
            </div>
        </div>
    </div>
