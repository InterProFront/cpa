...
@section('content')
    <div class="block ">
        ...
        <div class="field-wrap ">
            ...
            <textarea data-field-type="text" data-field-name="map" data-block="static_contacts"
                      class="input block_field" placeholder="Текст">{{$static_contacts->map_field}}</textarea>
        </div>
        <div class="field-wrap ">
            <label class="input-file">
            </label>
                ...
                <div class="drag-n-drop">
                    ...
                    <div class="img-hide-block">
                        <input type="hidden" class="prefix" data-field-name="head" data-field-type="image"
                               data-block="static_contacts" value="{{$static_contacts->head_image->prefix}}">
                        <input type="hidden" class="original_link" data-field-name="head" data-field-type="image"
                               data-block="static_contacts" value="{{$static_contacts->head_image->original_link}}">
                        <input type="hidden" class="preview_link" data-field-name="head" data-field-type="image"
                               data-block="static_contacts" value="{{$static_contacts->head_image->preview_link}}">
                        <input type="hidden" class="primary_link" data-field-name="head" data-field-type="image"
                               data-block="static_contacts" value="{{$static_contacts->head_image->primary_link}}">
                        <input type="hidden" class="secondary_link" data-field-name="head" data-field-type="image"
                               data-block="static_contacts" value="{{$static_contacts->head_image->secondary_link}}">
                        <input type="hidden" class="icon_link" data-field-name="head" data-field-type="image"
                               data-block="static_contacts" value="{{$static_contacts->head_image->icon_link}}">
                    </div>
                    <div class="preview-block">
                        <img src="/images/{{$static_contacts->head_image->preview_link}}" class="preview"
                             data-field-name="head" data-block="static_contacts">
                        <div class="buttons">
                    ...
                    <div class="action-block">
                        <input type="text" placeholder="alt текст" class="alt-text"
                               value="{{$static_contacts->head_image->alt}}" data-field-name="head"
                               data-block="static_contacts">
                        <label class="file-input">
                            Загрузить
                            <input type="file" accept="image/*" class="input_file block_field" data-entity="block"
                                   data-field-name="head" data-field-type="image" data-block="static_contacts">
                        </label>
                    </div>
                </div>
            </div>
