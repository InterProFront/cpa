<tr data-sorter="{{$item_course->sorter_field}}" data-id="{{$item_course->id_field}}">
    <td><a href="">{{$item_course->page_name_field}}</a></td>
    <td></td>
    <td>
    ...
    <td>
        <button type="button" class="any_delete" data-block="dom_study" data-group="course" data-entity="groupitem"
                data-item-id="{{$item_course->id_field}}" data-descr="Эл. первой группы"> Удалить
        </button>
    </td>
</tr>
