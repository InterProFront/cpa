            ...
            <div class="field-wrap ">
                ...
                <div class="image-load">
                    <div class="drag-n-drop">
                        <div class="drag"><input type="text" value="Отпустите клавишу мыши, чтобы загрузить файл"></div>
                        <div class="img-hide-block">
                            <input type="hidden" class="prefix" data-field-name="preview" data-group="service"
                                   data-field-type="image" data-item-id="{{$item_service->id_field}}"
                                   data-block="dom_service" value="{{$item_service->preview_image->prefix}}">
                            <input type="hidden" class="original_link" data-field-name="preview" data-group="service"
                                   data-field-type="image" data-item-id="{{$item_service->id_field}}"
                                   data-block="dom_service" value="{{$item_service->preview_image->original_link}}">
                            <input type="hidden" class="preview_link" data-field-name="preview" data-group="service"
                                   data-field-type="image" data-item-id="{{$item_service->id_field}}"
                                   data-block="dom_service" value="{{$item_service->preview_image->preview_link}}">
                            <input type="hidden" class="primary_link" data-field-name="preview" data-group="service"
                                   data-field-type="image" data-item-id="{{$item_service->id_field}}"
                                   data-block="dom_service" value="{{$item_service->preview_image->primary_link}}">
                            <input type="hidden" class="secondary_link" data-field-name="preview" data-group="service"
                                   data-field-type="image" data-item-id="{{$item_service->id_field}}"
                                   data-block="dom_service" value="{{$item_service->preview_image->secondary_link}}">
                            <input type="hidden" class="icon_link" data-field-name="preview" data-group="service"
                                   data-field-type="image" data-item-id="{{$item_service->id_field}}"
                                   data-block="dom_service" value="{{$item_service->preview_image->icon_link}}">
                        </div>
                        <div class="preview-block">
                            <img src="/images/{{$item_service->preview_image->preview_link}}" class="preview"
                                 data-field-name="preview" data-block="dom_service" data-group="service"
                                 data-item-id="{{$item_service->id_field}}">
                            <div class="buttons">
                                <span class="refresh"></span>
                                <span class="clear"></span>
                        ...
                        <div class="action-block">
                            <input type="text" placeholder="alt текст" class="alt-text"
                                   value="{{$item_service->preview_image->alt}}"
                                   data-item-id="{{$item_service->id_field}}" data-field-name="preview"
                                   data-block="dom_service">
                            <label class="file-input">
                                Загрузить
                                <input type="file" accept="image/*" class="input_file group_field"
                                       data-field-name="preview" data-field-type="image" data-block="dom_service"
                                       data-group="service" data-item-id="{{$item_service->id_field}}"
                                       data-entity="groupitem">
                            </label>
                        </div>
