                ...
                <div class="drag-n-drop">
                    ...
                    <div class="img-hide-block">
                        <input type="hidden" class="prefix" data-field-name="index_preview" data-field-type="image"
                               data-block="dom_study" value="{{$dom_study->index_preview_image->prefix}}">
                        <input type="hidden" class="original_link" data-field-name="index_preview"
                               data-field-type="image" data-block="dom_study"
                               value="{{$dom_study->index_preview_image->original_link}}">
                        <input type="hidden" class="preview_link" data-field-name="index_preview"
                               data-field-type="image" data-block="dom_study"
                               value="{{$dom_study->index_preview_image->preview_link}}">
                        <input type="hidden" class="primary_link" data-field-name="index_preview"
                               data-field-type="image" data-block="dom_study"
                               value="{{$dom_study->index_preview_image->primary_link}}">
                        <input type="hidden" class="secondary_link" data-field-name="index_preview"
                               data-field-type="image" data-block="dom_study"
                               value="{{$dom_study->index_preview_image->secondary_link}}">
                        <input type="hidden" class="icon_link" data-field-name="index_preview" data-field-type="image"
                               data-block="dom_study" value="{{$dom_study->index_preview_image->icon_link}}">
                    </div>
                    <div class="preview-block">
                        <img src="/images/{{$dom_study->index_preview_image->preview_link}}" class="preview"
                             data-field-name="index_preview" data-block="dom_study">
                        <div class="buttons">
                            <span class="refresh"></span>
                            <span class="clear"></span>
                        </div>
                    ...
                    <div class="action-block">
                        <input type="text" placeholder="alt текст" class="alt-text"
                               value="{{$dom_study->index_preview_image->alt}}" data-field-name="index_preview"
                               data-block="dom_study">
                        <label class="file-input">
                            Загрузить
                            <input type="file" accept="image/*" class="input_file block_field" data-entity="block"
                                   data-field-name="index_preview" data-field-type="image" data-block="dom_study">
                        </label>
                    </div>
                </div>
            </div>
